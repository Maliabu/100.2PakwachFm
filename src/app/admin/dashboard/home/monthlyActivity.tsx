...
export default function MonthlyActivity(props: {links: Cooky[], buttons: Cooky[], submissions: Cooky[]}) {
    ...
    return <div>
        <div className="bg-transparent hidden sm:block rounded-lg mt-2">
            <div className="flex justify-between p-2 border border-dark-subtle rounded-lg">
                <div className="text-xl font-bold tracking-tight">Monthly Activities</div>
                <div className="text-sm bg-primary text-white rounded-lg p-2 itens-center uppercase font-bold tracking-tight">{getMyMonth(today.getMonth()+1)}</div>
            </div>
