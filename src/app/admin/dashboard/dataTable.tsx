...
export function DataTableDemo<TData, TValue>({data, columns, id, name}: DataTableProps<TData, TValue>) {
  ...
  return (
    <div className="w-full">
        ...
        <div className="sm:flex items-center mt-4 p-2 bg-secondary rounded-md justify-between">
        ...
        {/* { id=="stock" && <Button className={table.getIsSomeRowsSelected() == true?"bg-foreground":"bg-secondary-foreground hover:bg-secondary-foreground"}>Manage Product</Button>} */}
        ...
        { id=="user" && <div className=" gap-1 flex">
            ...
            <Button className={table.getIsSomeRowsSelected() == true?"bg-foreground":"bg-secondary-foreground hover:bg-secondary-foreground"}>Deactivate</Button>
            </div>}
            </div>
        </div>
      ...
      <div className="text-sm p-2 bg-secondary rounded-md text-muted-foreground">Display: 10 rows per page</div>
      {
